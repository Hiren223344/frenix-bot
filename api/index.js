...
// Helper to sanitize markdown for Telegram
...
bot.hears('🔑 Generate API Key', async (ctx) => {
    ...
    try {
        ...
        ctx.replyWithMarkdownV2(
            ...
            Markup.inlineKeyboard([[Markup.button.url('Documentation', 'https://docs.frenix.sh/')]])
        );
    } catch (error) {
...
bot.hears('🛡️ Support', (ctx) => {
    ctx.reply('For technical integration support or business inquiries, contact @AdminSupport_GatewayBot.');
});
